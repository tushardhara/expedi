...
<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<div class="post_wrapper">
	    ...
	    <div class="post_header">
	    	...
	    	<?php echo _e( 'Av', THEMEDOMAIN ); ?> <?php echo get_the_author(); ?> den <?php echo get_the_time('d M Y'); ?> /
	    		<a href="<?php the_permalink(); ?>"><?php comments_number('Inga kommentarer', '1 Kommentar', '% Kommentarer'); ?></a>
	    	</div>
	    	<br class="clear"/>
	    	<h5 class="cufon"><a href="<?php the_permalink(); ?>" title="<?php the_title(); ?>"><?php the_title(); ?></a></h5>
	    </div>

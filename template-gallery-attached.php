...
<div id="page_content_wrapper">
    ...
    <div class="inner">
    	...
    	?>
    		...
    		?>	
    				<a class="fancy-gallery" data-fancybox-group="fancybox-thumb" href="<?php echo $image_url[0]; ?>" <?php if(!empty($pp_portfolio_enable_slideshow_title)) { ?>data-title="<?php echo $photo->post_title; ?> - <?php echo $photo->post_content; ?>"<?php } ?>>

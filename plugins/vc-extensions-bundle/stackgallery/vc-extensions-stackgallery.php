...
if (!class_exists('VC_Extensions_StackGallery')) {
    ...
    class VC_Extensions_StackGallery {
        ...
        function cq_vc_stackgallery_func($atts, $content=null) {
          ...
          $output .= '<div class="cq-stackgallery" data-width="'.$width.'" data-height="'.$height.'" data-easein="'.$easein.'" data-easeout="'.$easeout.'" data-containerheight="'.$containerheight.'" data-slideshow="'.$slideshow.'" data-slideshowdelay="'.$slideshowdelay.'" style="background:'.$background.' url('.$backgroundimage[0].') '.$repeat.'">';

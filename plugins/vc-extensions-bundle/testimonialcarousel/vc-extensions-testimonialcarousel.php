...
dHRwOi8vY29kZWNhbnlvbi5uZXQvdXNlci9zaWtlIj5MaW5rPC9hPg0KUHJvZHVjdCBNYW5hZ2Vy", 'vc_testimonialcarousel_cq'),
              ...
              array(
                ...
                "value" => __("100", 'vc_testimonialcarousel_cq'),
              ...
              array(
                ...
                "param_name" => "tpadding",
                "value" => __("", 'vc_testimonialcarousel_cq'),
                "description" => __("The CSS padding of the Testimonial content, leave it to blank if you don't now how it work, default is 20px.", 'vc_testimonialcarousel_cq')
              ),
              // array(
              //   "type" => "checkbox",
              //   "holder" => "",
              ...
              array(
                ...
                "holder" => "",
                "class" => "vc_testimonialcarousel_cq",
                "heading" => __("Margin left of the arrow", 'vc_testimonialcarousel_cq'),
              ...
              array(
                ...
                "holder" => "",
                "class" => "vc_testimonialcarousel_cq",
                "heading" => __("Margin left of the avatar", 'vc_testimonialcarousel_cq'),
                "param_name" => "avatarmarginleft",
                "value" => __("", 'vc_testimonialcarousel_cq'),
                "description" => __("The margin left of the avatar, default is 20px (leave it to be blank).", 'vc_testimonialcarousel_cq')
              ),
              array(
                "type" => "textfield",
                "holder" => "",
                "class" => "vc_testimonialcarousel_cq",
                "heading" => __("Margin of the name", 'vc_testimonialcarousel_cq'),
                "param_name" => "namemargin",
                "value" => __("", 'vc_testimonialcarousel_cq'),
                "description" => __("The margin the name, default is 20px 0 0 20px (leave it to be blank).", 'vc_testimonialcarousel_cq')
              ),
              array(
                "type" => "checkbox",
                "holder" => "",
          ...
          foreach ($testimonialcontentarr as $key => $value) {
              ...
              // if(wp_get_attachment_image_src(trim($value), 'full')){
                  ...
                  if($return_img_arr[0]!=""){
                    ...
                    $output .= '<img src="'.aq_resize($return_img_arr[0], $retina=="on"?$avatarwidth*2:$avatarwidth, $retina=="on"?$avatarheight*2:$avatarheight, true, true, true).'" width="'.$width.'" />';
                    if($avatarlinkarr[$i]!=""){
                      $output .= '</a>';
                    }
                    $output .= '</div>';

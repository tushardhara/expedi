...
if (!class_exists('VC_Extensions_DAGallery')) {
    ...
    class VC_Extensions_DAGallery {
        ...
        wpb_map( array(
            ...
            "icon" => "icon-wpb-vc_extension_cq",
            "category" => __('Sike Extensions', 'js_composer'),
            // 'admin_enqueue_js' => array(plugins_url('js/vc_fluidbox_cq_admin.js', __FILE__)),
            // 'admin_enqueue_css' => array(plugins_url('css/vc_fluidbox_cq_admin.css', __FILE__)),
            "params" => array(
              array(
                "type" => "attach_image",
        ...
        function cq_vc_dagallery_func($atts, $content=null) {
          ...
          wp_register_script('dagallery', plugins_url('js/jquery.gallery.min.js', __FILE__), array('jquery'));
        ...
        function cq_vc_fluidbox_func($atts, $content=null) {
          ...
          if($fluidimage==""){
            $output .= '<a href="'.plugins_url('img/blank_image.jpg', __FILE__).'" class="fluidbox-image" data-margin="'.$margin.'" data-float="'.$float.'" data-zindex="'.$zindex.'">';
            $output .= '<img src="'.plugins_url('img/blank_image.jpg', __FILE__).'" style="float:'.$float.';margin:'.$margin.'" width="'.$thumbwidth.'" />';
          }else{
            $output .= '<a href="'.$fluid_image[0].'" class="fluidbox-image" data-margin="'.$margin.'" data-float="'.$float.'" data-zindex="'.$zindex.'">';
